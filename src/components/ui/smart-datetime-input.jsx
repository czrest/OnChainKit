...
export const SmartDatetimeInput = React.forwardRef(({ className, value, onValueChange, placeholder, disabled }, ref) => {
  ...
  return (
    <div className="space-y-2 pr-3 py-3 relative ">
      ...
      <ScrollArea
        ...
        <ul
          className={cn("flex items-center flex-col gap-1 h-full max-h-56 w-28 px-1 py-0.5")}>
...
const NaturalLanguageInput = React.forwardRef(({ placeholder, ...props }, ref) => {
  const { value, onValueChange, Time, onTimeChange } = useSmartDateInput();
